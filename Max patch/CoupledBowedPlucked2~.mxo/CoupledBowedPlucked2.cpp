/* ------------------------------------------------------------
author: "David Suedholt"
name: "CoupledBowedPlucked2", "Coupled Finite Difference Schemes in Faust with Bowing and Pluckin"
version: "0.2"
Code generated with Faust 2.40.7 (https://faust.grame.fr)
Compilation options: -a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn CoupledBowedPlucked2 -es 1 -mcd 16 -uim -double -ftz 0
------------------------------------------------------------ */

#ifndef  __CoupledBowedPlucked2_H__
#define  __CoupledBowedPlucked2_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS CoupledBowedPlucked2
#endif
...
static double CoupledBowedPlucked2_faustpower2_f(double value) {
	return value * value;
}
static double CoupledBowedPlucked2_faustpower4_f(double value) {
	return value * value * value * value;
}

class CoupledBowedPlucked2 : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("author", "David Suedholt");
		m->declare("basics_lib_name", "Faust Basic Element Library");
		m->declare("basics_lib_version", "0.6");
		m->declare("compilation_options", "-single -scal -I libraries/ -I project/ -lang wasm");
		m->declare("compile_options", "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn CoupledBowedPlucked2 -es 1 -mcd 16 -uim -double -ftz 0");
		m->declare("contributor", "Marco Fiorini");
		m->declare("fds_lib_author", "Riccardo Russo");
		m->declare("fds_lib_name", "Faust Finite Difference Schemes Library");
		m->declare("fds_lib_version", "0.0");
		m->declare("filename", "CoupledBowedPlucked2.dsp");
		m->declare("library_path0", "/libraries/stdfaust.lib");
		m->declare("library_path1", "/libraries/fds.lib");
		...
		m->declare("name", "CoupledBowedPlucked2");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		double fConst1 = CoupledBowedPlucked2_faustpower2_f(1.0 / fConst0);
		fConst2 = 0.31830988618379069 * fConst1;
		fConst3 = 0.00086542272163559115 * fConst0;
		fConst4 = 1.9172441833157709e-05 * fConst0;
		fConst5 = 0.00086542272163559115 / fConst1;
		fConst6 = 9.5862209165788546e-06 * fConst0;
		fConst7 = 3.1415926535897931 / fConst1;
		fConst8 = 0.011076923076923074 * fConst0;
		fConst9 = 0.2938245103234991 * fConst1;
		fConst10 = 1.0 / fConst1;
		fConst11 = 2.0227160493827165e-11 / fConst1;
		fConst12 = 7.367111111111113e-11 * fConst0;
		fConst13 = 2.0000000000000002e-05 / fConst1;
		fConst14 = 3.642187499999999 * fConst0;
		fConst15 = 49999.999999999993 * fConst1;
		fConst16 = 44.100000000000001 / fConst0;
		fConst17 = 1.0 - fConst16;
	}
	
	virtual void instanceResetUserInterface() {
		fHslider0 = FAUSTFLOAT(0.00046000000000000001);
		fHslider1 = FAUSTFLOAT(1200.0);
		fEntry0 = FAUSTFLOAT(0.0);
		fHslider2 = FAUSTFLOAT(3000.0);
		fHslider3 = FAUSTFLOAT(0.10000000000000001);
		fHslider4 = FAUSTFLOAT(0.0);
		fHslider5 = FAUSTFLOAT(2.0);
		fButton0 = FAUSTFLOAT(0.0);
		fHslider6 = FAUSTFLOAT(1.0);
		fHslider7 = FAUSTFLOAT(147.0);
		fHslider8 = FAUSTFLOAT(1.3799999999999999);
		fHslider9 = FAUSTFLOAT(1500.0);
		fHslider10 = FAUSTFLOAT(3000.0);
		fHslider11 = FAUSTFLOAT(0.10000000000000001);
		fHslider12 = FAUSTFLOAT(0.0);
		fHslider13 = FAUSTFLOAT(2.0);
		fButton1 = FAUSTFLOAT(0.0);
		fHslider14 = FAUSTFLOAT(440.0);
		fHslider15 = FAUSTFLOAT(1.343);
		fHslider16 = FAUSTFLOAT(0.00046000000000000001);
		fHslider17 = FAUSTFLOAT(1200.0);
		fHslider18 = FAUSTFLOAT(3000.0);
		fHslider19 = FAUSTFLOAT(0.10000000000000001);
		fHslider20 = FAUSTFLOAT(0.0);
		fHslider21 = FAUSTFLOAT(2.0);
		fButton2 = FAUSTFLOAT(0.0);
		fHslider22 = FAUSTFLOAT(169.0);
		fHslider23 = FAUSTFLOAT(1.3799999999999999);
		fHslider24 = FAUSTFLOAT(0.00046000000000000001);
		fHslider25 = FAUSTFLOAT(1200.0);
		fHslider26 = FAUSTFLOAT(3000.0);
		fHslider27 = FAUSTFLOAT(0.10000000000000001);
		fHslider28 = FAUSTFLOAT(0.0);
		fHslider29 = FAUSTFLOAT(2.0);
		fButton3 = FAUSTFLOAT(0.0);
		fHslider30 = FAUSTFLOAT(247.0);
		fHslider31 = FAUSTFLOAT(1.3799999999999999);
		fHslider32 = FAUSTFLOAT(2.0);
		fHslider33 = FAUSTFLOAT(2.0);
		fHslider34 = FAUSTFLOAT(2.0);
		fHslider35 = FAUSTFLOAT(2.0);
	}
	...
	virtual CoupledBowedPlucked2* clone() {
		return new CoupledBowedPlucked2();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("CoupledBowedPlucked2");
		ui_interface->addHorizontalSlider("Bow Friction0", &fHslider3, FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(0.001), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("Bow Friction1", &fHslider19, FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(0.001), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("Bow Friction2", &fHslider27, FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(0.001), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("Bow Friction3", &fHslider11, FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(0.001), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.001));
		ui_interface->addHorizontalSlider("Bow velocity0", &fHslider4, FAUSTFLOAT(0.0), FAUSTFLOAT(-10.0), FAUSTFLOAT(10.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Bow velocity1", &fHslider20, FAUSTFLOAT(0.0), FAUSTFLOAT(-10.0), FAUSTFLOAT(10.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Bow velocity2", &fHslider28, FAUSTFLOAT(0.0), FAUSTFLOAT(-10.0), FAUSTFLOAT(10.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Bow velocity3", &fHslider12, FAUSTFLOAT(0.0), FAUSTFLOAT(-10.0), FAUSTFLOAT(10.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Bowing Force0", &fHslider2, FAUSTFLOAT(3000.0), FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(10000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Bowing Force1", &fHslider18, FAUSTFLOAT(3000.0), FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(10000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Bowing Force2", &fHslider26, FAUSTFLOAT(3000.0), FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(10000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Bowing Force3", &fHslider10, FAUSTFLOAT(3000.0), FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(10000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Damping 0", &fHslider8, FAUSTFLOAT(1.3799999999999999), FAUSTFLOAT(9.9999999999999995e-07), FAUSTFLOAT(100.0), FAUSTFLOAT(0.0001));
		ui_interface->addHorizontalSlider("Damping 1", &fHslider23, FAUSTFLOAT(1.3799999999999999), FAUSTFLOAT(9.9999999999999995e-07), FAUSTFLOAT(100.0), FAUSTFLOAT(0.0001));
		ui_interface->addHorizontalSlider("Damping 2", &fHslider31, FAUSTFLOAT(1.3799999999999999), FAUSTFLOAT(9.9999999999999995e-07), FAUSTFLOAT(100.0), FAUSTFLOAT(0.0001));
		ui_interface->addHorizontalSlider("Damping 3", &fHslider15, FAUSTFLOAT(1.343), FAUSTFLOAT(9.9999999999999995e-07), FAUSTFLOAT(100.0), FAUSTFLOAT(0.0001));
		ui_interface->addHorizontalSlider("Density 0", &fHslider1, FAUSTFLOAT(1200.0), FAUSTFLOAT(80.0), FAUSTFLOAT(5000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Density 1", &fHslider17, FAUSTFLOAT(1200.0), FAUSTFLOAT(80.0), FAUSTFLOAT(5000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Density 2", &fHslider25, FAUSTFLOAT(1200.0), FAUSTFLOAT(80.0), FAUSTFLOAT(5000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Density 3", &fHslider9, FAUSTFLOAT(1500.0), FAUSTFLOAT(80.0), FAUSTFLOAT(5000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addNumEntry("Exciter Mode", &fEntry0, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1.0));
		ui_interface->addHorizontalSlider("Input Point0", &fHslider5, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(1.0));
		ui_interface->addHorizontalSlider("Input Point1", &fHslider21, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(1.0));
		ui_interface->addHorizontalSlider("Input Point2", &fHslider29, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(1.0));
		ui_interface->addHorizontalSlider("Input Point3", &fHslider13, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(1.0));
		ui_interface->addHorizontalSlider("Output Point0", &fHslider35, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Output Point1", &fHslider34, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Output Point2", &fHslider33, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(0.01));
		ui_interface->addHorizontalSlider("Output Point3", &fHslider32, FAUSTFLOAT(2.0), FAUSTFLOAT(0.0), FAUSTFLOAT(4.0), FAUSTFLOAT(0.01));
		ui_interface->addButton("Play0", &fButton0);
		ui_interface->addButton("Play1", &fButton2);
		ui_interface->addButton("Play2", &fButton3);
		ui_interface->addButton("Play3", &fButton1);
		ui_interface->addHorizontalSlider("Plucking Force", &fHslider6, FAUSTFLOAT(1.0), FAUSTFLOAT(0.10000000000000001), FAUSTFLOAT(100.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Radius 0", &fHslider0, FAUSTFLOAT(0.00046000000000000001), FAUSTFLOAT(4.6e-05), FAUSTFLOAT(0.045999999999999999), FAUSTFLOAT(9.9999999999999995e-07));
		ui_interface->addHorizontalSlider("Radius 1", &fHslider16, FAUSTFLOAT(0.00046000000000000001), FAUSTFLOAT(4.6e-05), FAUSTFLOAT(0.045999999999999999), FAUSTFLOAT(9.9999999999999995e-07));
		ui_interface->addHorizontalSlider("Radius 2", &fHslider24, FAUSTFLOAT(0.00046000000000000001), FAUSTFLOAT(4.6e-05), FAUSTFLOAT(0.045999999999999999), FAUSTFLOAT(9.9999999999999995e-07));
		ui_interface->addHorizontalSlider("Tuning 0", &fHslider7, FAUSTFLOAT(147.0), FAUSTFLOAT(80.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Tuning 1", &fHslider22, FAUSTFLOAT(169.0), FAUSTFLOAT(80.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Tuning 2", &fHslider30, FAUSTFLOAT(247.0), FAUSTFLOAT(80.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->addHorizontalSlider("Tuning 3", &fHslider14, FAUSTFLOAT(440.0), FAUSTFLOAT(80.0), FAUSTFLOAT(1000.0), FAUSTFLOAT(0.10000000000000001));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow1 = CoupledBowedPlucked2_faustpower2_f(fSlow0);
		double fSlow2 = double(fHslider1);
		double fSlow3 = fSlow1 * fSlow2;
		double fSlow4 = fConst2 / fSlow3;
		int iSlow5 = int(double(fEntry0));
		double fSlow6 = double(fHslider3);
		double fSlow7 = 1.4099999999999999 * double(fHslider2) * fSlow6;
		double fSlow8 = double(fHslider4);
		int iSlow9 = fSlow8 == 0.0;
		double fSlow10 = double(fHslider5);
		double fSlow11 = double(((0.0 == fSlow10) ? 1 : 0));
		double fSlow12 = double(((1.0 == fSlow10) ? 1 : 0));
		double fSlow13 = double(((2.0 == fSlow10) ? 1 : 0));
		double fSlow14 = double(((3.0 == fSlow10) ? 1 : 0));
		double fSlow15 = double(((4.0 == fSlow10) ? 1 : 0));
		int iSlow16 = 1.0 - double(fButton0) > 0.0;
		double fSlow17 = 0.5 * double(fHslider6);
		int iSlow18 = int(fSlow10);
		int iSlow19 = int(fSlow10 + 1.0);
		double fSlow20 = std::floor(fSlow10);
		double fSlow21 = fSlow10 - fSlow20;
		double fSlow22 = fSlow20 + 1.0 - fSlow10;
		double fThen10 = ((0 == iSlow19) ? fSlow21 : 0.0);
		double fSlow23 = ((0 == iSlow18) ? fSlow22 : fThen10);
		double fSlow24 = CoupledBowedPlucked2_faustpower2_f(1.3 * double(fHslider7));
		double fSlow25 = 0.011736111111111112 * (0.0 - 6.2831853071795862 * fSlow3 * fSlow24);
		double fSlow26 = double(fHslider8);
		double fSlow27 = 0.0 - (fConst3 * fSlow2 * fSlow26 + 9424777960.7693787 * fSlow1) - fConst4 * fSlow2 + fConst5 * fSlow2;
		double fSlow28 = fSlow25 + fSlow1 * (fSlow27 + 1570796326.7948966 * fSlow1);
		double fSlow29 = fSlow1 * (0.036870080448380214 * fSlow2 * fSlow24 + 6283185307.1795864 * fSlow1 + fConst6 * fSlow2);
		double fSlow30 = 0.0 - 11404374017863.16 * CoupledBowedPlucked2_faustpower4_f(fSlow0);
		double fSlow31 = fSlow3 * (fConst0 * (6.2831853071795862 * fSlow26 + 0.13919672065136313) - fConst7);
		double fSlow32 = fConst8 * (0.0 - 6.2831853071795862 * fSlow3);
		double fSlow33 = double(fHslider9);
		double fSlow34 = 937499.99999999977 / fSlow33;
		double fSlow35 = 2.5209795264442234 / fSlow3 + fSlow34;
		double fSlow36 = fConst9 * (0.0 - fConst10 / fSlow35) / fSlow3;
		double fSlow37 = 24999.999999999996 / (fSlow33 * fSlow35);
		double fSlow38 = double(fHslider11);
		double fSlow39 = 1.4099999999999999 * double(fHslider10) * fSlow38;
		double fSlow40 = double(fHslider12);
		int iSlow41 = fSlow40 == 0.0;
		double fSlow42 = double(fHslider13);
		double fSlow43 = double(((0.0 == fSlow42) ? 1 : 0));
		double fSlow44 = double(((1.0 == fSlow42) ? 1 : 0));
		double fSlow45 = double(((2.0 == fSlow42) ? 1 : 0));
		double fSlow46 = double(((3.0 == fSlow42) ? 1 : 0));
		double fSlow47 = double(((4.0 == fSlow42) ? 1 : 0));
		int iSlow48 = 1.0 - double(fButton1) > 0.0;
		int iSlow49 = int(fSlow42);
		int iSlow50 = int(fSlow42 + 1.0);
		double fSlow51 = std::floor(fSlow42);
		double fSlow52 = fSlow42 - fSlow51;
		double fSlow53 = fSlow51 + 1.0 - fSlow42;
		double fThen21 = ((0 == iSlow50) ? fSlow52 : 0.0);
		double fSlow54 = ((0 == iSlow49) ? fSlow53 : fThen21);
		double fSlow55 = CoupledBowedPlucked2_faustpower2_f(0.32000000000000001 * double(fHslider14));
		double fSlow56 = double(fHslider15);
		double fSlow57 = 0.00071111111111111125 * (0.0 - 4.0000000000000003e-05 * fSlow33 * fSlow55) + fSlow33 * (fConst11 + fConst0 * (-1.4734222222222226e-10 - 2.0227160493827165e-11 * fSlow56)) + -2.0448;
		double fSlow58 = fSlow33 * (fConst12 + 1.4222222222222227e-08 * fSlow55) + 1.3632;
		double fSlow59 = fSlow33 * (fConst0 * (4.0000000000000003e-05 * fSlow56 + 0.00029137499999999997) - fConst13);
		double fSlow60 = fConst14 * (0.0 - 4.0000000000000003e-05 * fSlow33);
		double fThen23 = ((1 == iSlow50) ? fSlow52 : 0.0);
		double fSlow61 = ((1 == iSlow49) ? fSlow53 : fThen23);
		double fThen25 = ((1 == iSlow19) ? fSlow21 : 0.0);
		double fSlow62 = ((1 == iSlow18) ? fSlow22 : fThen25);
		double fSlow63 = fSlow25 + fSlow1 * fSlow27;
		double fThen27 = ((2 == iSlow19) ? fSlow21 : 0.0);
		double fSlow64 = ((2 == iSlow18) ? fSlow22 : fThen27);
		double fThen29 = ((3 == iSlow19) ? fSlow21 : 0.0);
		double fSlow65 = ((3 == iSlow18) ? fSlow22 : fThen29);
		double fThen31 = ((4 == iSlow19) ? fSlow21 : 0.0);
		double fSlow66 = ((4 == iSlow18) ? fSlow22 : fThen31);
		double fSlow67 = double(fHslider16);
		double fSlow68 = CoupledBowedPlucked2_faustpower2_f(fSlow67);
		double fSlow69 = double(fHslider17);
		double fSlow70 = fSlow68 * fSlow69;
		double fSlow71 = 1874999.9999999995 / fSlow33 + 2.5209795264442234 / fSlow70;
		double fSlow72 = fConst2 * (0.0 - fConst10 / fSlow71) / fSlow70;
		double fSlow73 = double(fHslider19);
		double fSlow74 = 1.4099999999999999 * double(fHslider18) * fSlow73;
		double fSlow75 = double(fHslider20);
		int iSlow76 = fSlow75 == 0.0;
		double fSlow77 = double(fHslider21);
		double fSlow78 = double(((0.0 == fSlow77) ? 1 : 0));
		double fSlow79 = double(((1.0 == fSlow77) ? 1 : 0));
		double fSlow80 = double(((2.0 == fSlow77) ? 1 : 0));
		double fSlow81 = double(((3.0 == fSlow77) ? 1 : 0));
		double fSlow82 = double(((4.0 == fSlow77) ? 1 : 0));
		int iSlow83 = 1.0 - double(fButton2) > 0.0;
		int iSlow84 = int(fSlow77);
		int iSlow85 = int(fSlow77 + 1.0);
		double fSlow86 = std::floor(fSlow77);
		double fSlow87 = fSlow77 - fSlow86;
		double fSlow88 = fSlow86 + 1.0 - fSlow77;
		double fThen42 = ((0 == iSlow85) ? fSlow87 : 0.0);
		double fSlow89 = ((0 == iSlow84) ? fSlow88 : fThen42);
		double fSlow90 = CoupledBowedPlucked2_faustpower2_f(1.3 * double(fHslider22));
		double fSlow91 = 0.011736111111111112 * (0.0 - 6.2831853071795862 * fSlow70 * fSlow90);
		double fSlow92 = double(fHslider23);
		double fSlow93 = 0.0 - (fConst3 * fSlow69 * fSlow92 + 9424777960.7693787 * fSlow68) - fConst4 * fSlow69 + fConst5 * fSlow69;
		double fSlow94 = fSlow91 + fSlow68 * (fSlow93 + 1570796326.7948966 * fSlow68);
		double fSlow95 = fSlow68 * (0.036870080448380214 * fSlow69 * fSlow90 + 6283185307.1795864 * fSlow68 + fConst6 * fSlow69);
		double fSlow96 = 0.0 - 11404374017863.16 * CoupledBowedPlucked2_faustpower4_f(fSlow67);
		double fSlow97 = fSlow70 * (fConst0 * (6.2831853071795862 * fSlow92 + 0.13919672065136313) - fConst7);
		double fSlow98 = fConst8 * (0.0 - 6.2831853071795862 * fSlow70);
		double fSlow99 = 49999.999999999993 / (fSlow33 * fSlow71);
		double fThen44 = ((2 == iSlow50) ? fSlow52 : 0.0);
		double fSlow100 = ((2 == iSlow49) ? fSlow53 : fThen44);
		double fSlow101 = fConst2 / fSlow70;
		double fThen46 = ((1 == iSlow85) ? fSlow87 : 0.0);
		double fSlow102 = ((1 == iSlow84) ? fSlow88 : fThen46);
		double fSlow103 = fSlow91 + fSlow68 * fSlow93;
		double fThen48 = ((2 == iSlow85) ? fSlow87 : 0.0);
		double fSlow104 = ((2 == iSlow84) ? fSlow88 : fThen48);
		double fThen50 = ((3 == iSlow85) ? fSlow87 : 0.0);
		double fSlow105 = ((3 == iSlow84) ? fSlow88 : fThen50);
		double fThen52 = ((4 == iSlow85) ? fSlow87 : 0.0);
		double fSlow106 = ((4 == iSlow84) ? fSlow88 : fThen52);
		double fSlow107 = double(fHslider24);
		double fSlow108 = CoupledBowedPlucked2_faustpower2_f(fSlow107);
		double fSlow109 = double(fHslider25);
		double fSlow110 = fSlow108 * fSlow109;
		double fSlow111 = fSlow34 + 2.5209795264442234 / fSlow110;
		double fSlow112 = fConst2 * (0.0 - fConst10 / fSlow111) / fSlow110;
		double fSlow113 = double(fHslider27);
		double fSlow114 = 1.4099999999999999 * double(fHslider26) * fSlow113;
		double fSlow115 = double(fHslider28);
		int iSlow116 = fSlow115 == 0.0;
		double fSlow117 = double(fHslider29);
		double fSlow118 = double(((0.0 == fSlow117) ? 1 : 0));
		double fSlow119 = double(((1.0 == fSlow117) ? 1 : 0));
		double fSlow120 = double(((2.0 == fSlow117) ? 1 : 0));
		double fSlow121 = double(((3.0 == fSlow117) ? 1 : 0));
		double fSlow122 = double(((4.0 == fSlow117) ? 1 : 0));
		int iSlow123 = 1.0 - double(fButton3) > 0.0;
		int iSlow124 = int(fSlow117);
		int iSlow125 = int(fSlow117 + 1.0);
		double fSlow126 = std::floor(fSlow117);
		double fSlow127 = fSlow117 - fSlow126;
		double fSlow128 = fSlow126 + 1.0 - fSlow117;
		double fThen63 = ((0 == iSlow125) ? fSlow127 : 0.0);
		double fSlow129 = ((0 == iSlow124) ? fSlow128 : fThen63);
		double fSlow130 = CoupledBowedPlucked2_faustpower2_f(1.3 * double(fHslider30));
		double fSlow131 = 0.011736111111111112 * (0.0 - 6.2831853071795862 * fSlow110 * fSlow130);
		double fSlow132 = double(fHslider31);
		double fSlow133 = 0.0 - (fConst3 * fSlow109 * fSlow132 + 9424777960.7693787 * fSlow108) - fConst4 * fSlow109 + fConst5 * fSlow109;
		double fSlow134 = fSlow131 + fSlow108 * (fSlow133 + 1570796326.7948966 * fSlow108);
		double fSlow135 = fSlow108 * (0.036870080448380214 * fSlow109 * fSlow130 + 6283185307.1795864 * fSlow108 + fConst6 * fSlow109);
		double fSlow136 = 0.0 - 11404374017863.16 * CoupledBowedPlucked2_faustpower4_f(fSlow107);
		double fSlow137 = fSlow110 * (fConst0 * (6.2831853071795862 * fSlow132 + 0.13919672065136313) - fConst7);
		double fSlow138 = fConst8 * (0.0 - 6.2831853071795862 * fSlow110);
		double fSlow139 = 49999.999999999993 / (fSlow33 * fSlow111);
		double fThen65 = ((3 == iSlow50) ? fSlow52 : 0.0);
		double fSlow140 = ((3 == iSlow49) ? fSlow53 : fThen65);
		double fThen67 = ((4 == iSlow50) ? fSlow52 : 0.0);
		double fSlow141 = ((4 == iSlow49) ? fSlow53 : fThen67);
		double fSlow142 = fConst2 / fSlow110;
		double fThen69 = ((1 == iSlow125) ? fSlow127 : 0.0);
		double fSlow143 = ((1 == iSlow124) ? fSlow128 : fThen69);
		double fSlow144 = fSlow131 + fSlow108 * fSlow133;
		double fThen71 = ((2 == iSlow125) ? fSlow127 : 0.0);
		double fSlow145 = ((2 == iSlow124) ? fSlow128 : fThen71);
		double fThen73 = ((3 == iSlow125) ? fSlow127 : 0.0);
		double fSlow146 = ((3 == iSlow124) ? fSlow128 : fThen73);
		double fThen75 = ((4 == iSlow125) ? fSlow127 : 0.0);
		double fSlow147 = ((4 == iSlow124) ? fSlow128 : fThen75);
		double fSlow148 = fConst15 / fSlow33;
		double fSlow149 = fConst16 * double(fHslider32);
		double fSlow150 = fConst16 * double(fHslider33);
		double fSlow151 = fConst16 * double(fHslider34);
		double fSlow152 = fConst16 * double(fHslider35);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			double fTemp0 = fSlow11 * fRec0[1] + fSlow12 * fRec1[1] + fSlow13 * fRec2[1] + fSlow14 * fRec3[1] + fSlow15 * fRec4[1];
			fVec0[0] = fTemp0;
			double fThen5 = fConst0 * (fTemp0 - fVec0[1]) - fSlow8;
			double fTemp1 = ((iSlow9) ? 0.0 : fThen5);
			int iThen6 = std::min<int>(221, iRec40[1] + 1);
			iRec40[0] = ((iSlow16) ? 0 : iThen6);
			double fElse7 = fSlow17 * (1.0 - std::cos(0.014279966607226332 * double(iRec40[0])));
			double fThen8 = 0.0 - fSlow7 * fTemp1 * std::exp(fTemp1 * (0.0 - fSlow6 * fTemp1) + 0.5);
			double fElse8 = 9.2307692307692299 * ((iRec40[0] <= 220) ? fElse7 : 0.0);
			double fTemp2 = ((iSlow5) ? fElse8 : fThen8);
			double fTemp3 = fSlow29 * fRec21[1];
			double fTemp4 = fSlow30 * fRec22[1];
			double fTemp5 = fTemp2 * fSlow23 + 7260.2499912468047 * (fSlow28 * fRec20[1] + fTemp3) + fTemp4 + fSlow31 * fRec20[2] + fSlow32 * fRec21[2];
			double fTemp6 = fSlow43 * fRec15[1] + fSlow44 * fRec16[1] + fSlow45 * fRec17[1] + fSlow46 * fRec18[1] + fSlow47 * fRec19[1];
			fVec1[0] = fTemp6;
			double fThen16 = fConst0 * (fTemp6 - fVec1[1]) - fSlow40;
			double fTemp7 = ((iSlow41) ? 0.0 : fThen16);
			int iThen17 = std::min<int>(221, iRec41[1] + 1);
			iRec41[0] = ((iSlow48) ? 0 : iThen17);
			double fElse18 = fSlow17 * (1.0 - std::cos(0.014279966607226332 * double(iRec41[0])));
			double fThen19 = 0.0 - fSlow39 * fTemp7 * std::exp(fTemp7 * (0.0 - fSlow38 * fTemp7) + 0.5);
			double fElse19 = 37.5 * ((iRec41[0] <= 220) ? fElse18 : 0.0);
			double fTemp8 = ((iSlow5) ? fElse19 : fThen19);
			double fTemp9 = fSlow58 * fRec36[1];
			double fTemp10 = fTemp8 * fSlow54 + 1977539.0624999998 * (fSlow57 * fRec35[1] + fTemp9) + fSlow59 * fRec35[2] + fSlow60 * fRec36[2];
			double fTemp11 = 673945.31249999988 * fRec37[1];
			double fTemp12 = fSlow58 * fRec37[1];
			double fTemp13 = fSlow60 * (fRec35[2] + fRec37[2]) + fTemp8 * fSlow61 + 1977539.0624999998 * (fSlow58 * fRec35[1] + fSlow57 * fRec36[1] + fTemp12) + fSlow59 * fRec36[2];
			double fTemp14 = 673945.31249999988 * fRec38[1];
			double fTemp15 = fSlow36 * fTemp5 + fSlow37 * (fTemp10 - fTemp11 + fTemp13 - fTemp14);
			fRec20[0] = fSlow4 * (fTemp5 + 8.5207100591715985 * fTemp15);
			double fTemp16 = fSlow29 * fRec22[1];
			fRec21[0] = fSlow4 * (fSlow32 * (fRec20[2] + fRec22[2]) + fTemp2 * fSlow62 + 7260.2499912468047 * (fSlow29 * fRec20[1] + fSlow63 * fRec21[1] + fTemp16) + fSlow30 * fRec23[1] + fSlow31 * fRec21[2]);
			double fTemp17 = fSlow29 * fRec23[1];
			fRec22[0] = fSlow4 * (fSlow32 * (fRec21[2] + fRec23[2]) + fSlow30 * (fRec20[1] + fRec24[1]) + fTemp2 * fSlow64 + 7260.2499912468047 * (fTemp3 + fSlow63 * fRec22[1] + fTemp17) + fSlow31 * fRec22[2]);
			fRec23[0] = fSlow4 * (fSlow32 * (fRec22[2] + fRec24[2]) + fTemp2 * fSlow65 + fSlow30 * fRec21[1] + 7260.2499912468047 * (fTemp16 + fSlow63 * fRec23[1] + fSlow29 * fRec24[1]) + fSlow31 * fRec23[2]);
			double fTemp18 = 7260.2499912468047 * (fTemp17 + fSlow28 * fRec24[1]) + fTemp2 * fSlow66 + fTemp4 + fSlow32 * fRec23[2] + fSlow31 * fRec24[2];
			double fTemp19 = fSlow78 * fRec5[1] + fSlow79 * fRec6[1] + fSlow80 * fRec7[1] + fSlow81 * fRec8[1] + fSlow82 * fRec9[1];
			fVec2[0] = fTemp19;
			double fThen37 = fConst0 * (fTemp19 - fVec2[1]) - fSlow75;
			double fTemp20 = ((iSlow76) ? 0.0 : fThen37);
			int iThen38 = std::min<int>(221, iRec42[1] + 1);
			iRec42[0] = ((iSlow83) ? 0 : iThen38);
			double fElse39 = fSlow17 * (1.0 - std::cos(0.014279966607226332 * double(iRec42[0])));
			double fThen40 = 0.0 - fSlow74 * fTemp20 * std::exp(fTemp20 * (0.0 - fSlow73 * fTemp20) + 0.5);
			double fElse40 = 9.2307692307692299 * ((iRec42[0] <= 220) ? fElse39 : 0.0);
			double fTemp21 = ((iSlow5) ? fElse40 : fThen40);
			double fTemp22 = fSlow95 * fRec26[1];
			double fTemp23 = fSlow96 * fRec27[1];
			double fTemp24 = fTemp21 * fSlow89 + 7260.2499912468047 * (fSlow94 * fRec25[1] + fTemp22) + fTemp23 + fSlow97 * fRec25[2] + fSlow98 * fRec26[2];
			double fTemp25 = fSlow58 * fRec38[1];
			double fTemp26 = fSlow60 * (fRec36[2] + fRec38[2]) + fTemp8 * fSlow100 + 1977539.0624999998 * (fTemp9 + fSlow57 * fRec37[1] + fTemp25) + fSlow59 * fRec37[2];
			double fTemp27 = 673945.31249999988 * (fRec35[1] + fRec39[1]);
			double fTemp28 = fSlow72 * (0.076923076923076872 * fTemp18 + 0.92307692307692313 * fTemp24) + fSlow99 * (fTemp26 - fTemp27);
			fRec24[0] = fSlow4 * (fTemp18 + 0.71005917159763265 * fTemp28);
			fRec25[0] = fSlow101 * (fTemp24 + 8.5207100591715985 * fTemp28);
			double fTemp29 = fSlow95 * fRec27[1];
			fRec26[0] = fSlow101 * (fSlow98 * (fRec25[2] + fRec27[2]) + fTemp21 * fSlow102 + 7260.2499912468047 * (fSlow95 * fRec25[1] + fSlow103 * fRec26[1] + fTemp29) + fSlow96 * fRec28[1] + fSlow97 * fRec26[2]);
			double fTemp30 = fSlow95 * fRec28[1];
			fRec27[0] = fSlow101 * (fSlow98 * (fRec26[2] + fRec28[2]) + fSlow96 * (fRec25[1] + fRec29[1]) + fTemp21 * fSlow104 + 7260.2499912468047 * (fTemp22 + fSlow103 * fRec27[1] + fTemp30) + fSlow97 * fRec27[2]);
			fRec28[0] = fSlow101 * (fSlow98 * (fRec27[2] + fRec29[2]) + fTemp21 * fSlow105 + fSlow96 * fRec26[1] + 7260.2499912468047 * (fTemp29 + fSlow103 * fRec28[1] + fSlow95 * fRec29[1]) + fSlow97 * fRec28[2]);
			double fTemp31 = 7260.2499912468047 * (fTemp30 + fSlow94 * fRec29[1]) + fTemp21 * fSlow106 + fTemp23 + fSlow98 * fRec28[2] + fSlow97 * fRec29[2];
			double fTemp32 = fSlow118 * fRec10[1] + fSlow119 * fRec11[1] + fSlow120 * fRec12[1] + fSlow121 * fRec13[1] + fSlow122 * fRec14[1];
			fVec3[0] = fTemp32;
			double fThen58 = fConst0 * (fTemp32 - fVec3[1]) - fSlow115;
			double fTemp33 = ((iSlow116) ? 0.0 : fThen58);
			int iThen59 = std::min<int>(221, iRec43[1] + 1);
			iRec43[0] = ((iSlow123) ? 0 : iThen59);
			double fElse60 = fSlow17 * (1.0 - std::cos(0.014279966607226332 * double(iRec43[0])));
			double fThen61 = 0.0 - fSlow114 * fTemp33 * std::exp(fTemp33 * (0.0 - fSlow113 * fTemp33) + 0.5);
			double fElse61 = 9.2307692307692299 * ((iRec43[0] <= 220) ? fElse60 : 0.0);
			double fTemp34 = ((iSlow5) ? fElse61 : fThen61);
			double fTemp35 = fSlow135 * fRec31[1];
			double fTemp36 = fSlow136 * fRec32[1];
			double fTemp37 = fTemp34 * fSlow129 + 7260.2499912468047 * (fSlow134 * fRec30[1] + fTemp35) + fTemp36 + fSlow137 * fRec30[2] + fSlow138 * fRec31[2];
			double fTemp38 = fSlow60 * (fRec37[2] + fRec39[2]) + fTemp8 * fSlow140 + 1977539.0624999998 * (fTemp12 + fSlow57 * fRec38[1] + fSlow58 * fRec39[1]) + fSlow59 * fRec38[2];
			double fTemp39 = 673945.31249999988 * fRec36[1];
			double fTemp40 = 1977539.0624999998 * (fTemp25 + fSlow57 * fRec39[1]) + fSlow60 * fRec38[2] + fTemp8 * fSlow141 + fSlow59 * fRec39[2];
			double fTemp41 = fSlow112 * (0.076923076923076872 * fTemp31 + 0.92307692307692313 * fTemp37) + fSlow139 * (0.50000000000000089 * (fTemp38 - fTemp39) + 0.49999999999999911 * (fTemp40 - fTemp11));
			fRec29[0] = fSlow101 * (fTemp31 + 0.71005917159763265 * fTemp41);
			fRec30[0] = fSlow142 * (fTemp37 + 8.5207100591715985 * fTemp41);
			double fTemp42 = fSlow135 * fRec32[1];
			fRec31[0] = fSlow142 * (fSlow138 * (fRec30[2] + fRec32[2]) + fTemp34 * fSlow143 + 7260.2499912468047 * (fSlow135 * fRec30[1] + fSlow144 * fRec31[1] + fTemp42) + fSlow136 * fRec33[1] + fSlow137 * fRec31[2]);
			double fTemp43 = fSlow135 * fRec33[1];
			fRec32[0] = fSlow142 * (fSlow138 * (fRec31[2] + fRec33[2]) + fSlow136 * (fRec30[1] + fRec34[1]) + fTemp34 * fSlow145 + 7260.2499912468047 * (fTemp35 + fSlow144 * fRec32[1] + fTemp43) + fSlow137 * fRec32[2]);
			fRec33[0] = fSlow142 * (fSlow138 * (fRec32[2] + fRec34[2]) + fTemp34 * fSlow146 + fSlow136 * fRec31[1] + 7260.2499912468047 * (fTemp42 + fSlow144 * fRec33[1] + fSlow135 * fRec34[1]) + fSlow137 * fRec33[2]);
			fRec34[0] = fSlow142 * (7260.2499912468047 * (fTemp43 + fSlow134 * fRec34[1]) + fTemp34 * fSlow147 + fTemp36 + fSlow138 * fRec33[2] + fSlow137 * fRec34[2]);
			double fTemp44 = 18.75 * fTemp15;
			fRec35[0] = fSlow148 * (fTemp10 - (fTemp11 + fTemp44));
			fRec36[0] = fSlow148 * (fTemp13 - (fTemp14 + fTemp44));
			fRec37[0] = fSlow148 * (fTemp26 - (fTemp27 + 37.5 * fTemp28));
			fRec38[0] = fSlow148 * (fTemp38 - (fTemp39 + 18.750000000000032 * fTemp41));
			fRec39[0] = fSlow148 * (fTemp40 - (fTemp11 + 18.749999999999964 * fTemp41));
			fRec0[0] = fRec20[0];
			fRec1[0] = fRec21[0];
			fRec2[0] = fRec22[0];
			fRec3[0] = fRec23[0];
			...
			fRec18[0] = fRec38[0];
			fRec19[0] = fRec39[0];
			fRec44[0] = fSlow149 + fConst17 * fRec44[1];
			int iTemp45 = int(fRec44[0]);
			int iTemp46 = int(fRec44[0] + 1.0);
			double fTemp47 = std::floor(fRec44[0]);
			double fTemp48 = fRec44[0] - fTemp47;
			double fTemp49 = fTemp47 + 1.0 - fRec44[0];
			double fThen77 = ((4 == iTemp46) ? fTemp48 : 0.0);
			double fThen79 = ((3 == iTemp46) ? fTemp48 : 0.0);
			double fThen81 = ((2 == iTemp46) ? fTemp48 : 0.0);
			double fThen83 = ((1 == iTemp46) ? fTemp48 : 0.0);
			fRec45[0] = fSlow150 + fConst17 * fRec45[1];
			int iTemp50 = int(fRec45[0]);
			int iTemp51 = int(fRec45[0] + 1.0);
			double fTemp52 = std::floor(fRec45[0]);
			double fTemp53 = fRec45[0] - fTemp52;
			double fTemp54 = fTemp52 + 1.0 - fRec45[0];
			double fThen85 = ((4 == iTemp51) ? fTemp53 : 0.0);
			double fThen87 = ((3 == iTemp51) ? fTemp53 : 0.0);
			double fThen89 = ((2 == iTemp51) ? fTemp53 : 0.0);
			double fThen91 = ((1 == iTemp51) ? fTemp53 : 0.0);
			fRec46[0] = fSlow151 + fConst17 * fRec46[1];
			int iTemp55 = int(fRec46[0]);
			int iTemp56 = int(fRec46[0] + 1.0);
			double fTemp57 = std::floor(fRec46[0]);
			double fTemp58 = fRec46[0] - fTemp57;
			double fTemp59 = fTemp57 + 1.0 - fRec46[0];
			double fThen93 = ((4 == iTemp56) ? fTemp58 : 0.0);
			double fThen95 = ((3 == iTemp56) ? fTemp58 : 0.0);
			double fThen97 = ((2 == iTemp56) ? fTemp58 : 0.0);
			double fThen99 = ((1 == iTemp56) ? fTemp58 : 0.0);
			fRec47[0] = fSlow152 + fConst17 * fRec47[1];
			int iTemp60 = int(fRec47[0]);
			int iTemp61 = int(fRec47[0] + 1.0);
			double fTemp62 = std::floor(fRec47[0]);
			double fTemp63 = fRec47[0] - fTemp62;
			double fTemp64 = fTemp62 + 1.0 - fRec47[0];
			double fThen101 = ((0 == iTemp61) ? fTemp63 : 0.0);
			double fThen103 = ((1 == iTemp61) ? fTemp63 : 0.0);
			double fThen105 = ((2 == iTemp61) ? fTemp63 : 0.0);
			double fThen107 = ((3 == iTemp61) ? fTemp63 : 0.0);
			double fThen109 = ((4 == iTemp61) ? fTemp63 : 0.0);
			double fThen111 = ((0 == iTemp56) ? fTemp58 : 0.0);
			double fThen113 = ((0 == iTemp51) ? fTemp53 : 0.0);
			double fThen115 = ((0 == iTemp46) ? fTemp48 : 0.0);
			double fTemp65 = fRec19[0] * ((4 == iTemp45) ? fTemp49 : fThen77) + fRec18[0] * ((3 == iTemp45) ? fTemp49 : fThen79) + fRec17[0] * ((2 == iTemp45) ? fTemp49 : fThen81) + fRec16[0] * ((1 == iTemp45) ? fTemp49 : fThen83) + fRec14[0] * ((4 == iTemp50) ? fTemp54 : fThen85) + fRec13[0] * ((3 == iTemp50) ? fTemp54 : fThen87) + fRec12[0] * ((2 == iTemp50) ? fTemp54 : fThen89) + fRec11[0] * ((1 == iTemp50) ? fTemp54 : fThen91) + fRec9[0] * ((4 == iTemp55) ? fTemp59 : fThen93) + fRec8[0] * ((3 == iTemp55) ? fTemp59 : fThen95) + fRec7[0] * ((2 == iTemp55) ? fTemp59 : fThen97) + fRec6[0] * ((1 == iTemp55) ? fTemp59 : fThen99) + fRec0[0] * ((0 == iTemp60) ? fTemp64 : fThen101) + fRec1[0] * ((1 == iTemp60) ? fTemp64 : fThen103) + fRec2[0] * ((2 == iTemp60) ? fTemp64 : fThen105) + fRec3[0] * ((3 == iTemp60) ? fTemp64 : fThen107) + fRec4[0] * ((4 == iTemp60) ? fTemp64 : fThen109) + fRec5[0] * ((0 == iTemp55) ? fTemp59 : fThen111) + fRec10[0] * ((0 == iTemp50) ? fTemp54 : fThen113) + fRec15[0] * ((0 == iTemp45) ? fTemp49 : fThen115);
			output0[i0] = FAUSTFLOAT(fTemp65);
			output1[i0] = FAUSTFLOAT(fTemp65);
			fVec0[1] = fVec0[0];
			iRec40[1] = iRec40[0];
			fVec1[1] = fVec1[0];
			iRec41[1] = iRec41[0];
	...
	#define FAUST_FILE_NAME "CoupledBowedPlucked2.dsp"
	#define FAUST_CLASS_NAME "CoupledBowedPlucked2"
	#define FAUST_COMPILATION_OPIONS "-a /usr/local/share/faust/max-msp/max-msp64.cpp -lang cpp -i -cn CoupledBowedPlucked2 -es 1 -mcd 16 -uim -double -ftz 0"
	#define FAUST_INPUTS 0
	#define FAUST_OUTPUTS 2
	#define FAUST_ACTIVES 41
	#define FAUST_PASSIVES 0

	FAUST_ADDHORIZONTALSLIDER("Bow Friction0", fHslider3, 0.10000000000000001, 0.001, 1000.0, 0.001);
	FAUST_ADDHORIZONTALSLIDER("Bow Friction1", fHslider19, 0.10000000000000001, 0.001, 1000.0, 0.001);
	FAUST_ADDHORIZONTALSLIDER("Bow Friction2", fHslider27, 0.10000000000000001, 0.001, 1000.0, 0.001);
	FAUST_ADDHORIZONTALSLIDER("Bow Friction3", fHslider11, 0.10000000000000001, 0.001, 1000.0, 0.001);
	FAUST_ADDHORIZONTALSLIDER("Bow velocity0", fHslider4, 0.0, -10.0, 10.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Bow velocity1", fHslider20, 0.0, -10.0, 10.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Bow velocity2", fHslider28, 0.0, -10.0, 10.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Bow velocity3", fHslider12, 0.0, -10.0, 10.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Bowing Force0", fHslider2, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Bowing Force1", fHslider18, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Bowing Force2", fHslider26, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Bowing Force3", fHslider10, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Damping 0", fHslider8, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001);
	FAUST_ADDHORIZONTALSLIDER("Damping 1", fHslider23, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001);
	FAUST_ADDHORIZONTALSLIDER("Damping 2", fHslider31, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001);
	FAUST_ADDHORIZONTALSLIDER("Damping 3", fHslider15, 1.343, 9.9999999999999995e-07, 100.0, 0.0001);
	FAUST_ADDHORIZONTALSLIDER("Density 0", fHslider1, 1200.0, 80.0, 5000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Density 1", fHslider17, 1200.0, 80.0, 5000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Density 2", fHslider25, 1200.0, 80.0, 5000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Density 3", fHslider9, 1500.0, 80.0, 5000.0, 0.10000000000000001);
	FAUST_ADDNUMENTRY("Exciter Mode", fEntry0, 0.0, 0.0, 1.0, 1.0);
	FAUST_ADDHORIZONTALSLIDER("Input Point0", fHslider5, 2.0, 0.0, 4.0, 1.0);
	FAUST_ADDHORIZONTALSLIDER("Input Point1", fHslider21, 2.0, 0.0, 4.0, 1.0);
	FAUST_ADDHORIZONTALSLIDER("Input Point2", fHslider29, 2.0, 0.0, 4.0, 1.0);
	FAUST_ADDHORIZONTALSLIDER("Input Point3", fHslider13, 2.0, 0.0, 4.0, 1.0);
	FAUST_ADDHORIZONTALSLIDER("Output Point0", fHslider35, 2.0, 0.0, 4.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Output Point1", fHslider34, 2.0, 0.0, 4.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Output Point2", fHslider33, 2.0, 0.0, 4.0, 0.01);
	FAUST_ADDHORIZONTALSLIDER("Output Point3", fHslider32, 2.0, 0.0, 4.0, 0.01);
	FAUST_ADDBUTTON("Play0", fButton0);
	FAUST_ADDBUTTON("Play1", fButton2);
	FAUST_ADDBUTTON("Play2", fButton3);
	FAUST_ADDBUTTON("Play3", fButton1);
	FAUST_ADDHORIZONTALSLIDER("Plucking Force", fHslider6, 1.0, 0.10000000000000001, 100.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Radius 0", fHslider0, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07);
	FAUST_ADDHORIZONTALSLIDER("Radius 1", fHslider16, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07);
	FAUST_ADDHORIZONTALSLIDER("Radius 2", fHslider24, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07);
	FAUST_ADDHORIZONTALSLIDER("Tuning 0", fHslider7, 147.0, 80.0, 1000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Tuning 1", fHslider22, 169.0, 80.0, 1000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Tuning 2", fHslider30, 247.0, 80.0, 1000.0, 0.10000000000000001);
	FAUST_ADDHORIZONTALSLIDER("Tuning 3", fHslider14, 440.0, 80.0, 1000.0, 0.10000000000000001);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Bow_Friction0, "Bow Friction0", fHslider3, 0.10000000000000001, 0.001, 1000.0, 0.001) \
		p(HORIZONTALSLIDER, Bow_Friction1, "Bow Friction1", fHslider19, 0.10000000000000001, 0.001, 1000.0, 0.001) \
		p(HORIZONTALSLIDER, Bow_Friction2, "Bow Friction2", fHslider27, 0.10000000000000001, 0.001, 1000.0, 0.001) \
		p(HORIZONTALSLIDER, Bow_Friction3, "Bow Friction3", fHslider11, 0.10000000000000001, 0.001, 1000.0, 0.001) \
		p(HORIZONTALSLIDER, Bow_velocity0, "Bow velocity0", fHslider4, 0.0, -10.0, 10.0, 0.01) \
		p(HORIZONTALSLIDER, Bow_velocity1, "Bow velocity1", fHslider20, 0.0, -10.0, 10.0, 0.01) \
		p(HORIZONTALSLIDER, Bow_velocity2, "Bow velocity2", fHslider28, 0.0, -10.0, 10.0, 0.01) \
		p(HORIZONTALSLIDER, Bow_velocity3, "Bow velocity3", fHslider12, 0.0, -10.0, 10.0, 0.01) \
		p(HORIZONTALSLIDER, Bowing_Force0, "Bowing Force0", fHslider2, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Bowing_Force1, "Bowing Force1", fHslider18, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Bowing_Force2, "Bowing Force2", fHslider26, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Bowing_Force3, "Bowing Force3", fHslider10, 3000.0, 0.10000000000000001, 10000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Damping_0, "Damping 0", fHslider8, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001) \
		p(HORIZONTALSLIDER, Damping_1, "Damping 1", fHslider23, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001) \
		p(HORIZONTALSLIDER, Damping_2, "Damping 2", fHslider31, 1.3799999999999999, 9.9999999999999995e-07, 100.0, 0.0001) \
		p(HORIZONTALSLIDER, Damping_3, "Damping 3", fHslider15, 1.343, 9.9999999999999995e-07, 100.0, 0.0001) \
		p(HORIZONTALSLIDER, Density_0, "Density 0", fHslider1, 1200.0, 80.0, 5000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Density_1, "Density 1", fHslider17, 1200.0, 80.0, 5000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Density_2, "Density 2", fHslider25, 1200.0, 80.0, 5000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Density_3, "Density 3", fHslider9, 1500.0, 80.0, 5000.0, 0.10000000000000001) \
		p(NUMENTRY, Exciter_Mode, "Exciter Mode", fEntry0, 0.0, 0.0, 1.0, 1.0) \
		p(HORIZONTALSLIDER, Input_Point0, "Input Point0", fHslider5, 2.0, 0.0, 4.0, 1.0) \
		p(HORIZONTALSLIDER, Input_Point1, "Input Point1", fHslider21, 2.0, 0.0, 4.0, 1.0) \
		p(HORIZONTALSLIDER, Input_Point2, "Input Point2", fHslider29, 2.0, 0.0, 4.0, 1.0) \
		p(HORIZONTALSLIDER, Input_Point3, "Input Point3", fHslider13, 2.0, 0.0, 4.0, 1.0) \
		p(HORIZONTALSLIDER, Output_Point0, "Output Point0", fHslider35, 2.0, 0.0, 4.0, 0.01) \
		p(HORIZONTALSLIDER, Output_Point1, "Output Point1", fHslider34, 2.0, 0.0, 4.0, 0.01) \
		p(HORIZONTALSLIDER, Output_Point2, "Output Point2", fHslider33, 2.0, 0.0, 4.0, 0.01) \
		p(HORIZONTALSLIDER, Output_Point3, "Output Point3", fHslider32, 2.0, 0.0, 4.0, 0.01) \
		p(BUTTON, Play0, "Play0", fButton0, 0.0, 0.0, 1.0, 1.0) \
		p(BUTTON, Play1, "Play1", fButton2, 0.0, 0.0, 1.0, 1.0) \
		p(BUTTON, Play2, "Play2", fButton3, 0.0, 0.0, 1.0, 1.0) \
		p(BUTTON, Play3, "Play3", fButton1, 0.0, 0.0, 1.0, 1.0) \
		p(HORIZONTALSLIDER, Plucking_Force, "Plucking Force", fHslider6, 1.0, 0.10000000000000001, 100.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Radius_0, "Radius 0", fHslider0, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07) \
		p(HORIZONTALSLIDER, Radius_1, "Radius 1", fHslider16, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07) \
		p(HORIZONTALSLIDER, Radius_2, "Radius 2", fHslider24, 0.00046000000000000001, 4.6e-05, 0.045999999999999999, 9.9999999999999995e-07) \
		p(HORIZONTALSLIDER, Tuning_0, "Tuning 0", fHslider7, 147.0, 80.0, 1000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Tuning_1, "Tuning 1", fHslider22, 169.0, 80.0, 1000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Tuning_2, "Tuning 2", fHslider30, 247.0, 80.0, 1000.0, 0.10000000000000001) \
		p(HORIZONTALSLIDER, Tuning_3, "Tuning 3", fHslider14, 440.0, 80.0, 1000.0, 0.10000000000000001) \
 ...
 */
class CoupledBowedPlucked2_poly : public dsp_voice_group, public dsp_poly {
    ...
    private:
        ...
        {
            if (val == FAUSTFLOAT(1)) {
                static_cast<CoupledBowedPlucked2_poly*>(arg)->allNotesOff(true);
            }
        }
    ...
    public:
         ...
         * Constructor.
         *
         * @param dsp - the dsp to be used for one voice. Beware: CoupledBowedPlucked2_poly will use and finally delete the pointer.
         ...
         *
         */
        CoupledBowedPlucked2_poly(dsp* dsp,
                   int nvoices,
                   bool control = false,
                   bool group = true)
        ...
        virtual ~CoupledBowedPlucked2_poly()
        {
            // Remove from fMidiHandler
        ...
        virtual CoupledBowedPlucked2_poly* clone()
        {
            return new CoupledBowedPlucked2_poly(fDSP->clone(), int(fVoiceTable.size()), fVoiceControl, fGroupControl);
        }
...
struct dsp_poly_factory : public dsp_factory {
    ...
    {
        dsp_poly* dsp_poly = new CoupledBowedPlucked2_poly(adaptDSP(fProcessFactory->createDSPInstance(), is_double), nvoices, control, group);
        if (fEffectFactory) {
...
void faust_allocate(t_faust* x, int nvoices)
{
    ...
    if (nvoices > 0) {
    ...
    #endif
        x->m_dsp = new CoupledBowedPlucked2_poly(new CoupledBowedPlucked2(), nvoices, true, true);
    #ifdef POLY2
        ...
        x->m_dsp = createSRAdapter<FAUSTFLOAT>(new CoupledBowedPlucked2(), DOWN_SAMPLING, UP_SAMPLING, FILTER_TYPE);
    }
...
void* faust_new(t_symbol* s, short ac, t_atom* av)
{
    ...
    CoupledBowedPlucked2* tmp_dsp = new CoupledBowedPlucked2();
...
#endif
{
    ...
    dsp* tmp_dsp = new CoupledBowedPlucked2();
    mspUI tmp_UI;
